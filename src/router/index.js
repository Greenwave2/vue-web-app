    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: '/system/device-manager/:gateway_id/values',
            component: () => import('@/views/device-manager/DeviceValues.vue'),
          },
          {
            path: '/system/device-manager/:gateway_id/config',
            component: () => import('@/views/device-manager/DeviceConfig.vue'),
          },
        ],
      },
      {
