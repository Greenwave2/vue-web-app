<template>
    <el-page-header @back="router.push('/')" content="Sign Up" style="background-color: white"></el-page-header>
    ...
    <el-form :model="form" class="middle-input-form">
        ...
        <el-input class="middle-input-box" placeholder="Check Password" v-model="form.check_password" show-password></el-input>
        <el-button style="margin-bottom: 20px;" type="primary" @click="signUp">Register</el-button>
    </el-form>
